...
\begin{table}[!h]
  ...
  จากตารางที่/ref{tab:functionaltesting}ป็นรายการสำหรับทดสอบการทํางานของฟังก์ชันต่างๆในแอพลิเคชัน เพื่อทดสอบว่าการตอบสนองต่อการใช้งานต่างๆเป็นไปตมที่ออกแบบไว้หรือไม่
\end{table}
