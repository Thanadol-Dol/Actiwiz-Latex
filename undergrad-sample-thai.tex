...
\begin{figure}[!h]\centering
  \setlength{\fboxrule}{0.5mm} % can define this in the preamble
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=8cm]{./Pictures/Screenshot_20240512_022025_ACTIWIZ.jpg}}
...
\begin{figure}[!h]\centering
  \setlength{\fboxrule}{0.5mm} % can define this in the preamble
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=8cm]{./Pictures/Screenshot_20240512_130252_One_UI_Home.jpg}}
...
\begin{figure}[!h]\centering
  \setlength{\fboxrule}{0.5mm} % can define this in the preamble
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=8cm]{./Pictures/user-tag.png}}
...
\begin{figure}[!h]\centering
  \setlength{\fboxrule}{0.5mm} % can define this in the preamble
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=8cm]{./Pictures/triangle.png}}
...
\begin{figure}[!h]\centering
  \setlength{\fboxrule}{0.5mm} % can define this in the preamble
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=8cm]{./Pictures/tag.png}}
...
\begin{itemize}
  ...
  \begin{figure}[!h]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
    \fbox{\includegraphics[width=8cm]{./Pictures/Scene1.png}}
...
\begin{itemize}
  ...
  \begin{figure}[!h]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
    \fbox{\includegraphics[width=8cm]{./Pictures/Scene2.png}}
...
\begin{itemize}
  ...
  \begin{figure}[!h]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
    \fbox{\includegraphics[width=8cm]{./Pictures/Scene3.png}}
...
\begin{itemize}
  ...
  \begin{figure}[!h]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
    \fbox{\includegraphics[width=8cm]{./Pictures/Scene4.png}}
...
\begin{itemize}
  ...
  \begin{figure}[!h]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
    \fbox{\includegraphics[width=8cm]{./Pictures/Scene5.jpg}}
...
\begin{itemize}
  ...
  \begin{figure}[!h]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
    \fbox{\includegraphics[width=8cm]{./Pictures/Scene6.png}}
...
\begin{itemize}
  ...
  \begin{figure}[!h]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
    \fbox{\includegraphics[width=8cm]{./Pictures/Scene7.png}}
...
\begin{itemize}
  ...
  \begin{figure}[!h]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
    \fbox{\includegraphics[width=8cm]{./Pictures/Scene8.png}}
...
\begin{itemize}
  ...
  \begin{figure}[!h]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
    \fbox{\includegraphics[width=8cm]{./Pictures/Scene9.png}}
...
\begin{itemize}
  ...
  \end{figure}
\end{itemize}
จากผลลัพธ์การประเมินในส่วนของการตอบโจทย์ของปัญหา พบว่าค่าเฉลี่ยของความพึงพอใจจากคะแนนจาก 5 คะแนนมีคะแนนเฉลี่ยอยู่ที่ 4.47 ซึ่งนับว่าค่าเฉลี่ยของผลการประเมินอยู่ในเกณฑ์ดีมาก
\newpage
\begin{itemize}
  \item ความสะดวกในการใช้งาน Application
  \begin{table}[!h]
    ...
    \begin{tabular}{|c|c|c|c|}
      ...
      \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}ระดับความพึงพอใจ} &
       ...
       5 & 20
         \\ \hline
    \end{tabular}
    \captionof{table}{\centering ความสะดวกในการใช้งาน Application}\label{tab:Featuresatisfaction}
  \end{table}
  \begin{figure}[!h]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
  ...
  \end{figure}
\end{itemize}
จากผลลัพธ์การประเมินในส่วนของความสะดวกในการใช้งาน Application นี้มี พบว่าค่าเฉลี่ยของความพึงพอใจจากคะแนนจาก 5 คะแนนมีคะแนนเฉลี่ยอยู่ที่ 4.58 ซึ่งนับว่าค่าเฉลี่ยของผลการประเมินอยู่ในเกณฑ์ดีมาก
\newpage
\begin{itemize}
  \item ความพึงพอใจโดยรวมของ Application นี้
  \begin{table}[!h]
    ...
    \begin{tabular}{|c|c|c|c|}
      ...
      \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}ระดับความพึงพอใจ} &
       ...
       5 & 19
         \\ \hline
    \end{tabular}
    \captionof{table}{\centering ความพึงพอใจโดยรวมของ Application}\label{tab:Featuresatisfaction}
  \end{table}
  \begin{figure}[!h]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
