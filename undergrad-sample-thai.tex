...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% First line of title
\def\disstitleone{Actiwiz: A mobile application for recommended event and club for KMUTT student}
...
King Mongkut's University of Technology Thonburi has established a curriculum that emphasizes the importance of participating in various activities for graduation. As a result, the university organizes no less than 150 activities each academic year. However, the dissemination of information about these activities is inefficient because the university's application for disseminating information, Modlink, recommends activities based on what the university wants to present rather than what students are interested in.

To address these issues, the project team proposes developing a mobile application using technologies such as React Native, which supports mobile applications. The focus will be on developing for the Android operating system to facilitate student participation in various activities and serve as a hub for disseminating information about activities in Thai. Artificial intelligence technology, written in Python, with its numerous libraries for AI development, will be used to recommend activities to students based on their individual interests. Factors such as the student's department, activities they have participated in, or activities that other students in the same department have participated in will be considered. This will make it easier for students to access university-organized activities and facilitate their participation in exchange for activity hours.

All data will be stored using a Graph Database like Neo4j, which stores data in the form of nodes and relationships, making it convenient to store user interests for the recommendation system. The application will support operations through APIs developed with one of Python's popular frameworks, FastAPI, ensuring seamless integration with the recommendation system developed in Python.

The project team aims to develop an application that facilitates student participation in activities and improves the efficiency of disseminating information about activities organized within the university. The goal is to recommend activities that best match the students' interests and needs.\begin{flushleft}
...
% \thaifont
\thaiabstract
มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรีกำหนดหลักสูตรให้การเข้าร่วมกิจกรรมต่าง ๆ มีความสำคัญกับการสำเร็จการศึกษา ทำให้มีการจัดกิจกรรมขึ้นมาในแต่ละปีการศึกษาไม่น้อยกว่า 150 รายการ แต่การกระจายข่าวสารของกิจกรรมต่าง ๆ ที่ทางมหาวิทยาลัยจัดขึ้นกลับไม่มีประสิทธิภาพ เนื่องจากแอปพลิเคชันสำหรับการกระจายข่าวสารต่าง ๆ ของทางมหาวิทยาลัยอย่าง Modlink มีวิธีการแนะนำกิจกรรมให้แก่นักศึกษาโดยเน้นไปที่ข่าวสารที่ทางมหาวิทยาลัยต้องการนำเสนอมากกว่ากิจกรรมที่นักศึกษาจะสนใจ จากปัญหาเหล่านี้ทำให้คณะผู้จัดทำจึงมีแนวคิดที่จะพัฒนาแอปพลิเคชันบนโทรศัพท์มือถือโดยอาศัยเทคโนโลยีอย่าง React Native ซึ่งสามารถรองรับการทำงานของแอพพลิเคชันบนโทรศัพท์มือถือ โดยเน้นการพัฒนาให้รองรับระบบปฏิบัติการ Android เพื่ออำนวยความสะดวกในการเข้าร่วมกิจกรรมต่าง ๆ ของนักศึกษาและเป็นศูนย์กลางในการกระจายข่าวสารของกิจกรรมต่าง ๆ ในภาษาไทย โดยจะนำเทคโนโลยีปัญญาประดิษฐ์ที่เขียนด้วยภาษา Python ซึ่งมี Library สำหรับการพัฒนาปัญญาประดิษฐ์อยู่จำนวนมาก มาใช้ในการแนะนำกิจกรรมต่าง ๆ ให้แก่นักศึกษาตามความสนใจของนักศึกษาแต่ละคนโดยพิจารณาจากปัจจัยต่าง ๆ เช่น  ภาควิชาที่เข้าศึกษา กิจกรรมที่นักศึกษาเคยเข้าร่วม หรือ กิจกรรมที่นักศึกษาในภาควิชาเดียวกันเคยเข้าร่วม เป็นต้น ซึ่งจะทำให้นักศึกษาสามารถเข้าถึงกิจกรรมต่าง ๆ ที่ทางมหาวิทยาลัยเป็นผู้จัดได้ง่ายขึ้น และอำนวยความสะดวกในการทำกิจกรรมต่าง ๆ กับทางมหาวิทยาลัย เพื่อแลกกับชั่วโมงการทำกิจกรรม ข้อมูลต่าง ๆ จะถูกจัดเก็บด้วย Graph Database อย่าง Neo4j ซึ่งเป็น Database ที่เก็บข้อมูลต่าง ๆ ไว้ในรูปแบบของโหนดและความสัมพันธ์ซึ่งอำนวยความสะดวกในการจัดเก็บความสนใจของผู้ใช้งานเอาไว้สำหรับการทำระบบการแนะนำ และมีการรองรับการทำงานของแอพพลิเคชันผ่าน API ที่พัฒนาด้วยหนึ่งใน Framework ที่ได้รับความนิยมของภาษา Python อย่าง FastAPI เพื่อให้แอพพลิเคชันนี้สามารถทำงานกับระบบการแนะนำที่ถูกพัฒนาด้วยภาษา Python ได้อย่างไร้รอยต่อ
ผู้จัดทำมีความตั้งใจที่จะพัฒนาแอปพลิเคชันที่จะอำนวยความสะดวกในการทำกิจกรรมของนักศึกษา และช่วยกระจายข่าวสารของกิจกรรมต่าง ๆ ที่ถูกจัดขึ้นภายในมหาวิทยาลัยให้มีประสิทธิภาพยิ่งขึ้น โดยมุ่งไปที่การแนะนำกิจกรรมที่ตรงกับความสนใจและความต้องการของนักศึกษาให้มากที่สุด 
...
\section{วัตถุประสงค์}
  \begin{enumerate}
    \item เพื่อพัฒนาแอปพลิเคชันบนโทรศัพท์มือถือสำหรับการกระจายข้อมูลข่าวสารและกิจกรรมต่าง ๆ ภายในมหาวิทยาลัย เพื่อให้ง่ายต่อการติดตามข่าวให้แก่นักศึกษาภายในมหาวิทยาลัย 
    ...
    \item แอปพลิเคชันที่อำนวยความสะดวกต่อนักศึกษาในการเข้าร่วม กิจกรรมต่าง ๆ ในรูปแบบภาษาไทย
...
\section{ตารางการดำเนินงาน}
  ...
  \begin{figure}[!h]\centering
    ...
    \caption{แผนการดำเนินงานในภาคการศึกษาที่ 1}\label{fig:Gantt_Chart_1st_Sem}
  \end{figure}
  ...
  \begin{figure}[!h]\centering
    ...
    \caption{แผนการดำเนินงานในภาคการศึกษาที่ 2}\label{fig:Gantt_Chart_2nd_Sem}
  \end{figure}
...
แอปพลิเคชันสำหรับการแนะนำกิจกรรม และชมรมให้แก่นักศึกษา โดยมีขีดความสามารถดังต่อไปนี้
  ...
  \begin{enumerate}
    ...
    \item ระบบแนะนำกิจกรรมและชมรม ตามความสนใจของผู้ใช้โดยอ้างอิงจาก tag ของกิจกรรมที่จัดกลุ่มจากเนื้อหาของกิจกรรม
...
\FloatBarrier
  \subsection {REST API} 
    ...
    \subsubsection {การออกแบบ REST API \cite{RestAPIDesign}}
      ...
      \begin{enumerate}
        \item สำหรับการออกแบบ RESTful API ควรเลือกใช้ HTTP Method ให้สอดคล้องกับลักษณะการดำเนินการของแต่ละ API ตามหลักการปฏิบัติที่ดี โดยทั่วไปไม่ควรใส่ชื่อกิริยาที่บ่งบอกถึงการดำเนินการของ API ไว้ในส่วนของ Path เช่น /createUsers หรือ \\ /getUserDetail เนื่องจากหน้าที่ของ API ปกติจะถูกกำหนดโดย HTTP Method ด้วยเหตุนี้ ชื่อ Path ควรเป็นชื่อของทรัพยากร (Resource) ที่เกี่ยวข้องกับ API ดังกล่าว เช่น /users หรือ /users/{userId} เป็นต้น
        \item การออกแบบ RESTful API ให้ตรงตามแนวปฏิบัติที่ดีมีหลักเกณฑ์สำคัญที่ควรยึดถือ ดังนี้

        \begin{itemize}
          \item URL Path ควรประกอบด้วยชื่อของ Resource เท่านั้น เช่น Users, Customers หรือ Orders เป็นต้น ซึ่งทรัพยากรเหล่านี้เป็นตัวแทนของข้อมูลหรือสิ่งของบางอย่าง
          \item ชื่อ Path ควรอยู่ในรูปพหูพจน์ของ Resource 
          \item ไม่ควรใส่ชื่อกิริยาที่บ่งบอกถึงวัตถุประสงค์ของการดำเนินการ เช่น add, update หรือ delete เป็นต้น เนื่องจากหน้าที่การดำเนินการปกติจะถูกกำหนดโดย HTTP Method
        \end{itemize}
      
        ตามหลักเกณฑ์ดังกล่าว หากต้องการ API ที่เกี่ยวข้องกับ Resource Users ซึ่งมีความสามารถในการสร้าง แก้ไข แสดง และลบข้อมูล User สามารถออกแบบ API Endpoint ได้ดังนี้
      
        \begin{itemize}
          \item สร้างข้อมูล User ใหม่: HTTP Method POST, Path /users
          \item แก้ไขข้อมูล User ที่มี id เท่ากับ 99: HTTP Method PUT, Path /users/99
          \item แสดงข้อมูล User ทั้งหมด: HTTP Method GET, Path /users
          \item แสดงข้อมูลของ User ที่มี id เท่ากับ 99: HTTP Method GET, Path /users/99
          \item ลบข้อมูล User ที่มี id เท่ากับ 99: HTTP Method DELETE, Path /users/99
        \end{itemize}

        ในกรณีที่ข้อมูลมีความสัมพันธ์เชื่อมโยงกัน เช่น ต้องการข้อมูลของ User ทั้งหมดที่อยู่ภายใต้ Customer ที่มี id เท่ากับ 2 สามารถใช้ Nested Endpoint แทนการใช้ Query String ได้ เช่น HTTP Method GET, Path /customers/2/users  อย่างไรก็ตาม หากข้อมูลมีความซับซ้อนจนทำให้ URL Path ยาวเกินไป อาจพิจารณาใช้ Query String หรือรับข้อมูลผ่าน Request Body แทน เพื่อให้ URL Path อ่านง่ายขึ้น ทั้งนี้ต้องพิจารณาจากกรณีการใช้งาน (Use Case) ประกอบด้วย
  
        \item การจัดการเวอร์ชันของ API (API Versioning)
         เป็นสิ่งสำคัญที่ควรดำเนินการ หากมีผู้ใช้งาน API อยู่แล้ว เนื่องจากการเปลี่ยนแปลงโครงสร้างหรือพฤติกรรมของ API ในขนาดใหญ่อาจส่งผลกระทบต่อระบบหรือแอปพลิเคชันของผู้ใช้งาน 
         ทำให้ไม่สามารถใช้งาน API ได้อย่างถูกต้อง ด้วยเหตุนี้ API ทุกตัวจึงควรมีการกำหนดเวอร์ชันไว้ เมื่อมีการเปลี่ยนแปลงรายละเอียดของ API อย่างมีนัยสำคัญ ก็สามารถแยกออกมาเป็นเวอร์ชันใหม่ 
         โดยเวอร์ชันเก่าและเวอร์ชันใหม่ต้องสามารถทำงานได้พร้อมกัน
         การระบุเวอร์ชันของ API สามารถทำได้โดยนำหมายเลขเวอร์ชันมาต่อหน้า URL Path ของ API endpoint เช่น POST /v1/users และ POST /v2/users เป็นต้น ซึ่งจะช่วยให้ผู้ใช้งานสามารถเลือกใช้งานเวอร์ชันของ API ที่ต้องการได้อย่างชัดเจน

        \item ในการออกแบบ API ควรมีการกำหนดรูปแบบการตั้งชื่อตัวแปร (Naming Conventions)
        ให้สอดคล้องกันทั้งระบบ เพื่อความเป็นมาตรฐานและง่ายต่อการทำความเข้าใจ สำหรับชื่อตัวแปรที่ปรากฏในส่วนของ Request Body และ Response ของ API รูปแบบที่นิยมใช้และพบเห็นบ่อยที่สุด ได้แก่ camel case และ snake case ทั้งนี้ผู้พัฒนาสามารถเลือกใช้รูปแบบใดรูปแบบหนึ่งตามความเหมาะสม อย่างไรก็ตาม หลังจากเลือกรูปแบบการตั้งชื่อแล้ว ควรยึดถือและใช้รูปแบบเดียวกันอย่างสม่ำเสมอทั่วทั้งระบบ เพื่อให้เกิดความสอดคล้องและสะดวกต่อการทำงานร่วมกัน

        \item การใช้งานพารามิเตอร์ให้เหมาะสม: พารามิเตอร์คือการส่งข้อมูลผ่าน query ที่ต่อท้าย URL path ซึ่งมีการกระทำต่าง ๆ ดังนี้
          \begin{itemize}
            \item Filtering (การกรองข้อมูล) สามารถกรองข้อมูลตามเงื่อนไขที่ต้องการ โดยส่งผ่าน query ที่ต่อท้าย URL path เช่น \\ GET /orders?name=MyOrders\&customerId=2 ผลลัพธ์ที่ได้คือข้อมูลของ order ที่มีชื่อว่า "MyOrders" และอยู่ใน customer ID ที่ 2 ข้อมูล Nested ที่มีจำนวนมาก หรือต้องการกรองข้อมูลจำนวนมาก ถ้านำมาใช้เป็น URL path จะมีความยาวจนเกินไป จึงสามารถนำมาใส่ใน filter ต่อท้าย URL path แทนได้
            \item Sorting (การจัดเรียงข้อมูล) สามารถเรียงลำดับข้อมูลที่เรียกมาแสดงผลได้ ซึ่งการออกแบบ sort ที่ดีจะต้องยืดหยุ่น \\ สามารถเรียงจากน้อยไปมาก หรือมากไปน้อยได้ โดยใส่ query เข้าไปต่อท้าย path คล้ายกับ filter \\เช่น
                  GET /users?sort by=+email หรือ GET /users?sort by=-email จากตัวอย่างทางด้านบน +email คือการเรียงจากน้อยไปมาก และ -email เรียงจากมากไปน้อย หรือสามารถเขียนในรูปแบบอื่นๆ ได้เช่น
                  \begin{itemize} 
                  ...
                  \end{itemize}   
            หลักสำคัญคือต้องมีความยืดหยุ่น สามารถเปลี่ยนลำดับการเรียงข้อมูลได้ และผู้ใช้สามารถเข้าใจได้ว่าเป็นการเรียงลำดับแบบไหน       
          \end{itemize} 

          \begin{itemize} 
            \item Searching (การค้นหาข้อมูล) หลักการคล้ายกับการกรองข้อมูล คือการค้นหาข้อมูลตามเงื่อนไขที่กำหนด โดยส่งผ่าน query ที่ต่อท้าย URL ตัวอย่างเช่น เมื่อต้องการค้นหาชื่อของ order ที่ชื่อว่า "THAIPOST1234" ในระบบ จะส่งผ่านทาง query params ดังนี้
            \begin{itemize} 
              \item GET /orders?search='THAIPOST1234'
            \end{itemize}
            ...
            \end{figure}
              pagination จะช่วยแบ่งข้อมูลออกมาเป็นส่วนเล็ก ๆ โดยจะสามารถ query เพื่อระบุหน้า จำนวนข้อมูลที่ต้องการแสดงได้ เช่น GET /orders?page=2\&limit=50
        ...
        หลังจากที่ผู้ใช้ API (Client) ส่ง request ไปยัง server ผ่าน API แล้ว ฝั่ง client จะต้องยืนยันว่า API ใช้งานได้จริงหรือไม่ หรือส่งไปสำเร็จหรือไม่ ดังนั้นจึงจำเป็นต้องมีการส่ง response ที่มี HTTP Status Code ระบุ กลับไปยัง client เพื่อบอกว่า request นั้น ๆ ผ่าน (Pass), ล้มเหลว (Fail) หรือมีข้อผิดพลาด (Error)หลังจากที่ผู้ใช้ API (Client) ส่ง request ไปยัง server ผ่าน API แล้ว ฝั่ง client จะต้องยืนยันว่า API ใช้งานได้จริงหรือไม่ หรือส่งไปสำเร็จหรือไม่ ดังนั้นจึงจำเป็นต้องมีการส่ง response ที่มี HTTP Status Code ระบุ กลับไปยัง client เพื่อบอกว่า request นั้น ๆ ผ่าน (Pass), ล้มเหลว (Fail) หรือมีข้อผิดพลาด (Error)
        ในกรณีที่สำเร็จ (Success) จะมี HTTP Status Code ที่ใช้งานกันทั่วไป ได้แก่
          \begin{itemize}
            \item 200 Ok: เป็นมาตรฐานของ HTTP response เพื่อบ่งบอกว่า request นั้นสำเร็จ ใช้สำหรับ GET, PUT หรือ POST
            \item 201 Created: เป็น response เพื่อบ่งบอกว่าข้อมูลใหม่ได้ถูกสร้างขึ้นสำเร็จ ใช้สำหรับ POST
            \item 204 No Content: เป็น response สำหรับบ่งบอกว่าดำเนินการสำเร็จ แต่ไม่ได้ return ข้อมูลกลับ ส่วนใหญ่จะใช้กรณีลบข้อมูล (DELETE) ที่ไม่ได้ส่ง response ที่เป็นข้อมูลกลับไป
            
        ในกรณีที่เกิดข้อผิดพลาด (Error) จะมี HTTP Status Code ที่ใช้งานกันทั่วไป ได้แก่
            ...
            \item 429 Too many Request: เป็น response ที่บ่งบอกว่า request นั้นติด limit ใช้กรณีที่กำหนด rate limit ไว้ว่า API ดังกล่าว จะสามารถเรียกได้กี่ครั้ง
            \item 500 Internal Server Error: เป็น response ที่บ่งบอกว่าการ request นั้นถูกต้องแล้ว แต่ server ไม่สามารถตอบสนองได้ ซึ่งอาจจะเป็นที่ตัวโค้ดของระบบเอง
            \item 503 Service Unavailable: เป็น response ที่บ่งบอกว่า server ใช้การไม่ได้ โดย Server จะไม่สามารถรับ request ที่ส่งเข้ามาได้
            \item 504 Bad Gateway Gateway Timeout: การตอบกลับที่แสดงให้เห็นว่าเว็บเซิร์ฟเวอร์ เช่น Nginx หรือ Apache มีปัญหา จะสังเกตได้ว่า HTTP Status Code แต่ละตัวมีความหมายชัดเจน ดังนั้น การออกแบบที่ดีจึงต้องเลือกใช้ HTTP Status Code ให้ตรงตามวัตถุประสงค์ เพื่อให้ผู้ใช้งานที่ได้รับการตอบกลับสามารถเข้าใจ response นั้นได้ดียิ่งขึ้น \\
          \end{itemize}
        \item การ Handle Error ให้ user เข้าใจ
        การจัดการข้อผิดพลาดให้ผู้ใช้งานเข้าใจ ควรออกแบบการตอบกลับสำหรับกรณีต่าง ๆ ของข้อผิดพลาด นอกเหนือจากการใช้ HTTP Status Code เพื่อให้ผู้ใช้งานเข้าใจข้อผิดพลาดของ API มากขึ้น ตัวอย่างเช่น ในกรณีที่คำขอส่งบางพารามิเตอร์มาไม่ถูกต้อง แทนที่จะตอบกลับไปเพียงว่า
  ...
  โหนดในกราฟเปรียบเสมือน entity ที่สามารถเก็บ attribute ได้จำนวนมากในบริบทของกราฟ attribute เหล่านี้เรียกว่าคุณสมบัติ ความสัมพันธ์หมายถึงการเชื่อมโยงระหว่างสองโหนด และเช่นเดียวกับโหนด ความสัมพันธ์ก็สามารถเก็บคุณสมบัติได้เช่นกัน \\
\end{enumerate}
...
\newpage
  ...
  การส่งข้อมูลในรูปแบบดังกล่าวจะช่วยให้ user เข้าใจได้ทันทีว่า field ใดที่มีรูปแบบไม่ถูกต้อง
...
\end{enumerate}
  ...
  \begin{table}[!h]\centering
    ...
    Pre-conditions              & - \\ \hline
    Main success scenario &
      \begin{tabular}[c]{@{}c@{}}1.User กดปุ่มเพื่อไปยังหน้าเข้าสู่ระบบของ Microsoft \\ 2.User กรอกอีเมลและรหัสผ่าน\\ 3.User เข้าสู่ homepage ของแอปพลิเคชัน\\ 4.ระบบแสดงฟังก์ชันที่ใช้งานได้ทั้งหมด\\ 5.User ใช้งานฟังก์ชันต่าง ๆ ในแอปพลิเคชัน\end{tabular} \\ \hline
    \end{tabular}
...
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=6cm]{./Pictures/LoadSearchAct.png}}
...
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=6cm]{./Pictures/LoadSearchClub.png}}
  \caption{ขอข้อมูลกิจกรรมเพิ่มตอนค้นหาชมรม}\label{fig:LoadSearchClub}
\end{figure}
...
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=6cm]{./Pictures/info-event.png}}
...
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=6cm]{./Pictures/info-club.png}}
...
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=6cm]{./Pictures/info-event-join.png}}
...
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=6cm]{./Pictures/info-event-joined.png}}
...
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=6cm]{./Pictures/info-club-leave.png}}
...
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=6cm]{./Pictures/17.png}}
...
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=6cm]{./Pictures/log-out.png}}
...
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=6cm]{./Pictures/log-out-confirm.png}}
  ...
  \resizebox{\textwidth}{!}{%
    \begin{tabular}{cccl}
      ...
      \multicolumn{1}{|c|}{} &
        ...
        \multicolumn{1}{l|}{\cellcolor[HTML]{34FF34} เป็นไปตามที่คาดหวัง} \\ \cline{2-4} 
      \multicolumn{1}{|c|}{} &
      ...
      \multicolumn{1}{|c|}{\multirow{-4}{*}{Login}} &
        ...
        \multicolumn{1}{l|}{\cellcolor[HTML]{34FF34} เป็นไปตามที่คาดหวัง} \\ \hline
      \multicolumn{1}{|c|}{} &
      ...
      \multicolumn{1}{|c|}{Recommendation} &
        ...
        \multicolumn{1}{c|}{\cellcolor[HTML]{34FF34} เป็นไปตามที่คาดหวัง} \\ \hline
      \multicolumn{1}{l}{} &
        \multicolumn{1}{l}{} &
        \multicolumn{1}{l}{} &
         \\
...
\subsection{การดำเนินงานในภาคการศึกษาที่ 1}
  \subsubsection{การเตรียมการเริ่มต้นโครงการ}
    \begin{table}[!h]\centering
      ...
      \end{tabular}
      \captionof{table}{\centering ตารางรายการการเตรียมการเริ่มต้นโครงการ}\label{tab:Preparation}
      \end{table}
  ...
  \subsubsection{ศึกษาวิธีการพัฒนาแอปพลิเคชัน}
    \begin{table}[!h]\centering
      ...
      \end{tabular}
      \captionof{table}{\centering ตารางรายการการศึกษาวิธีการพัฒนาแอปพลิเคชัน}\label{tab:DevelopmentLearning}
      \end{table}
  ...
  \subsubsection{ออกแบบแอปพลิเคชัน}
    \begin{table}[!h]\centering
      ...
      \end{tabular}
      \captionof{table}{\centering ตารางรายการการออกแบบแอปพลิเคชัน}\label{tab:ApplicationDesign}
      \end{table}
  ...
  \subsubsection{จัดเตรียมข้อมูล}
    \begin{table}[!h]\centering
      ...
      \end{tabular}
      \captionof{table}{\centering ตารางรายการการจัดเตรียมข้อมูล}\label{tab:DataPreparation}
      \end{table}
  ...
  \subsubsection{การพัฒนาแอปพลิเคชัน}
    \begin{table}[H]\centering
      ...
      \end{tabular}
      \captionof{table}{\centering ตารางรายการการพัฒนาแอปพลิเคชัน}\label{tab:ApplicationDevelopment}
      \end{table}
    ...
    \subsubsection{การทดสอบแอปพลิเคชัน}
      \begin{table}[H]\centering
        ...
        \end{tabular}
        \captionof{table}{\centering ตารางรายการการทดสอบแอปพลิเคชัน}\label{tab:ApplicationTesting}
        \end{table}
