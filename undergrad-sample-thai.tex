...
หลังจากผู้ใช้กดปุ่มแล้วแอปพลิเคชันจะส่ง Request ไปยัง Backend System เพื่อขอ Login URL และใช้ Login URL ดังกล่าวผ่าน Webview ของแอปพลิเคชันเพื่อร้องขอหน้าเข้าสู่ระบบของ Microsoft ตาม รูปที่ \ref{fig:2}
...
\begin{figure}[H]\centering
 ...
 \begin{enumerate}
  ...
  \item API Token สำหรับการขอข้อมูลจาก Microsoft Graph Service และ 
  \item Refresh Token สำหรับการขอ API token 2 token ข้างต้นใหม่
\end{enumerate}
 
\newpage

 \subsubsection{กรณีที่เคยลงชื่อเข้าใช้ในแอปพลิเคชัน}
...
มาให้กับทางแอปพลิเคชันเพื่อใช้ในการเข้าใช้ระบบอื่น ๆ ของทางแอปพลิเคชันต่อไป และเปลี่ยนหน้าของแอปพลิเคชันเป็นหน้าสำหรับการแนะนำกิจกรรมตาม รูปที่ \ref{fig:3} 

\subsubsection{แนะนํากิจกรรมตามความสนใจของผู้ใช้โดยอ้างอิงจาก tag ของกิจกรรม}
หลังจากทำการเข้าสู่ระบบ ผู้ใช้จะเข้ามาสู่หน้าแนะนำกิจกรรมตาม รูปที่ \ref{fig:3} โดยในการแนะนำกิจกรรม แอปพลิเคชันจะส่ง Request ไปยัง Backend System 
...
หลังจากทำการเข้าสู่ระบบ ผู้ใช้สามารถกดไปที่ปุ่ม Club ที่อยู่ด้านล่างเพื่อเปลี่ยนรูปแบบของแอปพลิเคชันเป็นโหมดสำหรับชมรมตาม รูปที่ \ref{fig:3} 
...
จากหน้าแนะนำกิจกรรม รูปที่ \ref{fig:3}   หรือหน้าค้นหากิจกรรม รูปที่ \ref{fig:6}  ผู้ใช้สามารถกดเข้าไปในการ์ดของกิจกรรมที่ตัวเองสนใจได้ จากนั้นแอปพลิเคชันจะเปลี่ยนเป็นหน้าที่แสดงรายละเอียดของกิจกรรมนั้น โดยเป็นการนำข้อมูลจากการ์ดที่ผู้ใช้กดมาแสดง ตาม รูปที่  \ref{fig:13}
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
...
จากหน้าแนะนำชมรม รูปที่ \ref{fig:10}  หรือหน้าค้นหาชมรม รูปที่ \ref{fig:11} ผู้ใช้สามารถกดเข้าไปในการ์ดของชมรมที่ตัวเองสนใจได้ จากนั้นแอปพลิเคชันจะเปลี่ยนเป็นหน้าที่แสดงรายละเอียดของชมรมนั้น โดยเป็นการนำข้อมูลจากการ์ดที่ผู้ใช้กดมาแสดง ตาม รูปที่ \ref{fig:14}
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
...
จากหน้าแสดงรายละเอียดกิจกรรม รูปที่ \ref{fig:13} หากผู้ใช้เลื่อนลงมาจนถึงด้านล่างสุดของหน้าตาม รูปที่  \ref{fig:15}
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
...
จากหน้าแสดงรายละเอียดชมรม รูปที่ \ref{fig:14} ผู้ใช้สามารถกดปุ่มเพื่อเข้าร่วมชมรมดังกล่าวได้ และหลังจากกดเข้าร่วมแล้วจะมีการส่ง Request ไปหา Backend System เพื่อเก็บข้อมูลการเข้าร่วมของผู้ใช้และเปลี่ยนรูปแบบปุ่มเข้าร่วมชมรมเป็นปุ่มออกจากชมรมตาม รูปที่ \ref{fig:17}
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
...
จากหน้าแนะนำกิจกรรมและชมรมตาม รูปที่ \ref{fig:3} ผู้ใช้สามารถออกจากระบบได้ด้วยการกดปุ่ม Profile ทางด้านบนซ้ายของ รูปที่ \ref{fig:3} ได้เพื่อเข้าไปที่หน้า User Profile ตาม รูปที่  \ref{fig:19}
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=6cm]{./Pictures/log-out.png}}
  \caption{หน้าข้อมูลผู้ใช้}\label{fig:19}
\end{figure}
หลังจากนั้นผู้ใช้สามารถกดปุ่ม LOG OUT และระบบจะแจ้งเตือนขึ้นว่า ARE YOU SURE? ตาม รูปที่  \ref{fig:20}
\begin{figure}[H]\centering
  \setlength{\fboxrule}{0.5mm}
  \setlength{\fboxsep}{0.5cm}
...
\end{figure}
โดยผู้ใช้สามารถกดปุ่ม Yes เพื่อออกจากระบบได้ หลังจากนั้นแอปพลิเคชันจะลบ Token ทั้งหมดและนำผู้ใช้กลับมายังหน้าแรกสุดของแอปพลิเคชันตาม รูปที่ \ref{fig:1} หรือผู้ใช้สามารถเลือกที่จะกดปุ่ม No เพื่อยกเลิกการออกจากระบบได้
...
\begin{table}[!h]
  ...
  \resizebox{\textwidth}{!}{
    \begin{tabular}{|c|c|c|l|}
      ...
      Login &
      กรณีผู้ใช้ไม่กรอกอีเมล &
      \begin{tabular}[c]{@{}l@{}}กรณีผู้ใช้ไม่กรอกอีเมล จะมีการแจ้งเตือนให้ผู้ใช้\\ กรอกอีเมลก่อนที่จะกดเข้าสู่ระบบ\end{tabular} &
      \cellcolor[HTML]{34FF34}เป็นไปตามที่คาดหวัง \\ \hline
      Login &
      กรณีผู้ใช้ไม่กรอกอีเมลไม่ถูกต้อง &
      \begin{tabular}[c]{@{}l@{}}กรณีผู้ใช้ไม่กรอกอีเมลไม่ถูกต้อง จะมีการแจ้งเตือน\\ ให้ผู้ใช้กรอกอีเมลใหม่ก่อนที่จะกดเข้าสู่ระบบ\end{tabular} &
      \cellcolor[HTML]{34FF34}เป็นไปตามที่คาดหวัง \\ \hline
      Login &
      กรณีผู้ใช้ไม่กรอกรหัสผ่าน &
      \begin{tabular}[c]{@{}l@{}}กรณีผู้ใช้ไม่กรอกรหัสผ่าน จะมีการแจ้งเตือนให้ผู้ใช้\\ กรอกรหัสผ่านก่อนที่จะกดเข้าสู่ระบบ\end{tabular} &
      \cellcolor[HTML]{34FF34}เป็นไปตามที่คาดหวัง \\ \hline
      Login &
      กรณีผู้ใช้กรอกรหัสผ่านผิด &
      \begin{tabular}[c]{@{}l@{}}กรณีผู้ใช้กรอกรหัสผ่านผิด จะมีการแจ้งเตือนให้ผู้ใช้\\ กรอกรหัสผ่านใหม่ก่อนที่จะกดเข้าสู่ระบบ\end{tabular} &
      \cellcolor[HTML]{34FF34}เป็นไปตามที่คาดหวัง \\ \hline
      Create Account &
      กรณีที่ไม่มีบัญชีผู้ใช้ในฐานข้อมูล &
      \begin{tabular}[c]{@{}l@{}}กรณีที่ไม่มีบัญชีผู้ใช้ในฐานข้อมูล ระบบจะให้ผู้ใช้\\ กรอกข้อมูลส่วนตัวก่อนที่จะเข้าสู่ระบบ\end{tabular} &
      \cellcolor[HTML]{34FF34}เป็นไปตามที่คาดหวัง \\ \hline
      Create Account &
      กรณีที่ผู้ใช้กรอกข้อมูล &
      \begin{tabular}[c]{@{}l@{}}กรณีผู้ใช้กรอกข้อมูลไม่ครบ ระบบจะไม่สามารถสร้างบัญชี\\ ได้จนกว่าผู้ใช้จะกรอกข้อมูลให้ครบถ้วน\end{tabular} &
      \cellcolor[HTML]{34FF34}เป็นไปตามที่คาดหวัง \\ \hline
      Logout &
      กรณีที่ผู้ใช้ต้องการออกจากระบบ &
      \begin{tabular}[c]{@{}l@{}}กรณีผู้ใช้ต้องการออกจากระบบจะมีการแจ้งเตือน\\ ถามยืนยันการออกจากระบบก่อนที่จะออกจากระบบ\end{tabular} &
      \cellcolor[HTML]{34FF34}เป็นไปตามที่คาดหวัง \\ \hline
      Logout &
      \begin{tabular}[c]{@{}l@{}}กรณีผู้ใช้กดปุ่ม No หรือ กดนอก\\ กรอบแจ้งเตือน\end{tabular} &
      \begin{tabular}[c]{@{}l@{}}กรณีผู้ใช้กดปุ่ม No หรือ กดนอกกรอบแจ้งเตือนจะถือว่า\\ เป็นการยกเลิกการออกจากระบบทั้งสองอย่าง\end{tabular} &
      \cellcolor[HTML]{34FF34}เป็นไปตามที่คาดหวัง \\ \hline
      Search &
      กรณีที่ผู้ใช้ต้องการค้นหากิจกรรม &
      \begin{tabular}[c]{@{}l@{}}กรณีที่ผู้ใช้ต้องการค้นหากิจกรรม \\ จะสามารถหาได้จากแถบค้นหาของแอปพลิเคชัน\end{tabular} &
      \cellcolor[HTML]{34FF34}เป็นไปตามที่คาดหวัง \\ \hline
      FeedPage (Event) &
      \begin{tabular}[c]{@{}l@{}}กรณีผู้ใช้ลองกดเข้าไปดูรายละเอียดของกิจกรรม\\ ที่ไม่มีข้อมูล\end{tabular} &
      \begin{tabular}[c]{@{}l@{}}กรณีผู้ใช้ลองกดเข้าไปดูรายละเอียดของกิจกรรม\\ ที่ไม่มีข้อมูล จะไม่พบข้อมูลใดๆ\end{tabular} &
      \cellcolor[HTML]{34FF34}เป็นไปตามที่คาดหวัง \\ \hline
      FeedPage (Club) &
      \begin{tabular}[c]{@{}l@{}}กรณีผู้ใช้ลองกดเข้าไปดูรายละเอียดของชมรม\\ ที่ไม่มีข้อมูล\end{tabular} &
      \begin{tabular}[c]{@{}l@{}}กรณีผู้ใช้ลองกดเข้าไปดูรายละเอียดของชมรม\\ ที่ไม่มีข้อมูล จะไม่พบข้อมูลใดๆ\end{tabular} &
      \cellcolor[HTML]{34FF34}เป็นไปตามที่คาดหวัง \\ \hline
      Notification &
      กรณีผู้ใช้ตรวจสอบการแจ้งเตือนของตัวแอปพลิเคชั่น &
      \begin{tabular}[c]{@{}l@{}}กรณีผู้ใช้ตรวจสอบการแจ้งเตือนของตัวแอปพลิเคชั่น \\ จะมีการแสดงการแจ้งเตือนทั้งหมดที่เกิดขึ้นในแอปพลิเคชั่น\end{tabular} &
      \cellcolor[HTML]{34FF34}เป็นไปตามที่คาดหวัง \\ \hline
      Recommendation &
      \begin{tabular}[c]{@{}l@{}}กรณีผู้ใช้ตรวจสอบกิจกรรมที่ทางระบบแนะนำมาให้\\ โดยในตัวอย่างนี้จะเป็นการอ้างอิงจากคณะที่ผู้ใช้อยู่\end{tabular} &
      \begin{tabular}[c]{@{}l@{}}กรณีผู้ใช้ตรวจสอบกิจกรรมที่ทางระบบแนะนำมาให้ \\ โดยในตัวอย่างนี้จะเป็นการอ้างอิงจากคณะที่ผู้ใช้อยู่\end{tabular} &
      \cellcolor[HTML]{34FF34}เป็นไปตามที่คาดหวัง \\ \hline
    \end{tabular}
  }
