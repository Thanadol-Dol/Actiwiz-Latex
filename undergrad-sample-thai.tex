...
\section {F-Shape Pattern}
  \subsection{F-Shaped Pattern คืออะไร}
...
\end{figure}
\hspace*{1cm} หน้าเข้าสู่ระบบ จะเป็นหน้าแรกที่ผู้ใช้งานเห็นเมื่อเข้าใช้งานแอปพลิเคชัน โดยจะมีช่องให้กรอก Username และ Password และปุ่ม Login เพื่อเข้าสู่ระบบ หากผู้ใช้งานยังไม่มีบัญชีผู้ใช้งานสามารถกดปุ่ม Register เพื่อสมัครสมาชิกใหม่ หรือหากลืมรหัสผ่านสามารถกดปุ่ม Forgot Password เพื่อกู้คืนรหัสผ่าน
...
\newpage
  ...
  ในบทนี้เราจะกล่าวถึงการพัฒนาของโครงการ โดยแอปพลิเคชั่นของเราจะแบ่งออกเป็นหัวข้อใหญ่ได้ดังนี้
...
\begin{figure}[H]\centering
  ...
  \caption{หน้า Profile}\label{fig:19}
\end{figure}
...
\begin{figure}[H]\centering
  ...
  \caption{การยืนยันการ Log Out}\label{fig:20}
\end{figure}
