...
รายละเอียดของโครงการที่เปลี่ยนแปลงไปจากภาคการศึกษาที่ 1 ประกอบไปด้วยส่วนของการออกแบบแอปพลิเคชันต่าง ๆ ดังนี้
 \subsection{รายการคุณลักษณะ (Feature List)}
   นำ Feature สำหรับการลงทะเบียนผู้ใช้กับระบบของแอปพลิเคชันออก
   และเปลี่ยนเป็นการ Login และ Authenticate ผู้ใช้ผ่านระบบของ Microsoft Entra ID
   ที่ให้ผู้ใช้สามารถ Login ด้วย Kmutt Internet Account ที่่ผู้ใช้ลงทะเบียนไว้กับมหาวิทยาลัยไว้แล้ว
   โดยไม่ต้องลงทะเบียนแอปพลิเคชันซ้ำอีก
 \subsection{เเผนภาพที่ใช้เเสดงปฎิสัมพันธ์ระหว่างระบบงานเเละสิ่งที่อยู่นอกระบบงาน (Use Case Diagram)}
   นำ Use Case ที่เกี่ยวกับการลงทะเบียนออก และแผนภาพที่ได้ทำการแก้ไขใหม่จะออกมาเป็นดังนี้
   \begin{figure}[!h]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
    \fbox{\includegraphics[width=13cm]{./Pictures/V4_Use_Cases_Diagram.png}}
 ...
 \subsection{เเผนภาพที่ใช้เเสดงการทำงานของระบบ (Sequence Diagram)}
   นำแผนภาพที่เกี่ยวกับการลงทะเบียนออก และแก้ไขแผนภาพที่แสดงขั้นตอนการ login เข้าสู่ระบบใหม่ เพื่อแสดงขั้นตอนที่เปลี่ยนไป
   และแผนภาพที่ได้ทำการแก้ไขใหม่จะออกมาเป็นดังนี้
   \begin{figure}[H]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
  ...
  \begin{table}[!h]
    ...
    \hline
    \rowcolor[HTML]{9FC5E8} 
    \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}รายการฟังก์ชั่นที่จะส่งมอบ}                                                                    & หลักฐาน & สถานะ      \\ \hline
    ระบบ Log in ผ่านอีเมลของมหาวิทยาลัย                                                                                                         &         & กำลังพัฒนา \\ \hline
  ...
  \begin{tabular}{|l|l|l|l|}
    ...
    Evaluate Page &
      ...
      ระบบพาผู้ใช้เข้าสู่หน้า login เพื่อประเมินกิจกรรม &
       \\ \hline
  \end{tabular}
  \captionof{table}{\centering ตารางการทดสอบการทดสอบการทํางาน}\label{tab:functionaltesting}
  จากตารางที่ \ref{tab:functionaltesting} เป็นรายการสำหรับทดสอบการทํางานของฟังก์ชันต่างๆในแอพลิเคชัน เพื่อทดสอบว่าการตอบสนองต่อการใช้งานต่างๆเป็นไปตามที่ออกแบบไว้หรือไม่
\end{table}
