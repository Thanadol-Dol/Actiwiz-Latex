...
\begin{figure}[!h]\centering
  \setlength{\fboxrule}{0.5mm} % can define this in the preamble
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=8cm]{./Pictures/Mobile_Arc2.png}}
  \caption{หน้า Feed ของแอปพลิเคชัน ACTIWIZ}\label{fig:FeedPages}
\end{figure}
...
\begin{itemize}
  ...
  \begin{table}[!h]
    ...
    \begin{figure}[!h]\centering
      ...
      \setlength{\fboxsep}{0.5cm}
      \fbox{\includegraphics[width=8cm]{./Pictures/Response1.png}}
      \caption{แผนภูมิแสดงผลตอบรับว่าแอปพลิเคชั่นนี้แก้ไขปัญหาได้มากน้อยเพียงใด}\label{fig:Response}
    \end{figure}
  \end{table}
