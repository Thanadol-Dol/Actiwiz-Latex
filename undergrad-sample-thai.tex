...
รายละเอียดของโครงการที่เปลี่ยนแปลงไปจากภาคการศึกษาที่ 1 ประกอบไปด้วยส่วนของการออกแบบแอปพลิเคชันต่าง ๆ ดังนี้
 ...
 \subsection{เเผนรูปที่ใช้เเสดงปฎิสัมพันธ์ระหว่างระบบงานเเละสิ่งที่อยู่นอกระบบงาน (Use Case Diagram)}
  ...
  \begin{table}[!h]
    ...
    \hline
    \rowcolor[HTML]{9FC5E8} 
    \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}รายการฟังก์ชันที่จะส่งมอบ}                                                                    & สถานะ      \\ \hline
    ระบบ Login ผ่านอีเมลของมหาวิทยาลัย                                                                                                         &\cellcolor[HTML]{34FF34} เสร็จสิ้น \\ \hline
    \begin{tabular}[c]{@{}l@{}}ระบบรวบรวมข้อมูลของชมรมต่าง ๆ เอาไว้ โดยผู้ใช้สามารถค้นหาและ\\ ติดตามข้อมูลของชมรมที่ตนเองสนใจได้\end{tabular}   &\cellcolor[HTML]{34FF34} เสร็จสิ้น \\ \hline
    ระบบแจ้งเตือนกิจกรรมที่เกี่ยวข้องกับชมรมหรือความสนใจของนักศึกษา                                                                             &\cellcolor[HTML]{34FF34} เสร็จสิ้น \\ \hline
    ระบบแจ้งเตือนการประเมินผลกิจกรรม เมื่อฟอร์มการประเมินพร้อมใช้งาน                                                                            &\cellcolor[HTML]{34FF34} เสร็จสิ้น \\ \hline
    \begin{tabular}[c]{@{}l@{}}ระบบแนะนํากิจกรรมและชมรม ตามความสนใจของผู้ใช้โดยอ้างอิง\\ จาก tag ของกิจกรรม\end{tabular}                        &\cellcolor[HTML]{34FF34} เสร็จสิ้น \\ \hline
    \begin{tabular}[c]{@{}l@{}}ระบบวิเคราะห์ความสนใจของผู้ใช้ผ่านเนื้อหาของกิจกรรมที่ผู้ใช้เคยเข้าร่วม\\  เข้าไปอ่านรายละเอียด หรือเกี่ยวข้องกับชมรมที่สนใจ\end{tabular} &\cellcolor[HTML]{34FF34} เสร็จสิ้น \\ \hline
    \begin{tabular}[c]{@{}l@{}}ระบบแยกประเภทกิจกรรมอัตโนมัติโดยวิเคราะห์จากเนื้อหา \\ ออกมาเป็น tag ต่าง ๆ โดยใช้ Machine Learning\end{tabular} &\cellcolor[HTML]{34FF34} เสร็จสิ้น \\ \hline
    \end{tabular}
    \captionof{table}{\centering ตารางรายการฟังก์ชันที่จะส่งมอบ}
  \end{table}
\section{การทดสอบการทำงานของระบบ (Functional Testing)}
\begin{table}[!h]
  \centering
