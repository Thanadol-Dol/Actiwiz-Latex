...
\def\disstitletwo{แอปพลิเคชันสำหรับการแนะนำกิจกรรมและชมรมสำหรับนักศึกษามหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี}
\def\disstitlethree{(Application for recommended event and club for KMUTT student)}      
% Your first name and lastname
\def\dissauthor{นาย คุณานนต์ ทรัพย์มามูล (Mr. Kunanon Supmamul) 63070501011}   % 1st member
\def\dissauthortwo{นาย ณภัทรัก เหมือนเตย (Mr. Naphattarak Muentoey) 63070501018}   % 2nd member
\def\dissauthorthree{นาย ธนดล ทองฤทธิ์ (Mr. Thanadol Thongrit) 63070501029}   % 3rd member
...
สถาปัตยกรรมของแอปพลิเคชันส่วนใหญ่จะประกอบด้วยสาม Layer หลัก ๆ ได้แก่ Presentation layer, Business layer และ Data layer
  \begin{enumerate} 
    \item Presentation layer\cite{MobileAppArchitecture} \\
          เป็นส่วนของแอปพลิเคชันที่ผู้ใช้มองเห็นและมีปฏิสัมพันธ์ด้วยได้ โดยมีส่วนติดต่อผู้ใช้ (user interface หรือ UI) ของแอปพลิเคชันเป็นส่วนสำคัญของ layer นี้
          วัตถุประสงค์หลักของ layer นี้คือการนำข้อมูลที่ส่งมาจาก business layer มาแสดงผลในลักษณะที่ผู้ใช้สามารถเข้าใจได้
...
\newpage
    ...
    \item Business layer \cite{MobileAppArchitecture} \\
          layer นี้จะประกอบด้วยตรรกะหลักของแอปพลิเคชัน หรือก็คือวิธีการทำงานของแอปพลิเคชัน โดยมักจะเป็นการนำข้อมูลที่ผู้ใช้ป้อนหรือข้อมูลจาก Data layer มาประมวลผล จากนั้นจึงส่งไปยัง presentation layer
...
\subsubsection {C.R.A.P. Principle Design}
  ...
  \begin{enumerate}
    ...
    คือการจัดวางองค์ประกอบของข้อมูล โดยข้อมูลที่มีความเชื่อมโยงกันควรจัดให้เป็นกลุ่มก้อนเดียวกัน จะช่วยให้ข้อมูลในหน้าเว็บไซต์ หรือแอปพลิเคชันที่เราออกแบบมีความซับซ้อนน้อยลง และมีการแบ่งหมวดหมู่ชัดเจนขึ้น ซึ่งจะเห็นได้ดังตัวอย่างในรูปที่ \ref{fig:proximity}
...
\section{แบบสำรวจผลิตภัณฑ์}
  ModLink คือแอปพลิเคชันของทางมหาวิทยาลัยโดยข้อมูลภายใน แอปพลิเคชันนั้น จะเกี่ยวกับข้อมูลกิจกรรมต่าง ๆ ภายในมหาวิทยาลัย และข้อมูลส่วนตัวของนักศึกษา อย่างไรก็ตาม feature การแสดงข้อมูลเกี่ยวกิจกรรมของแอปพลิเคชันนี้ยังถือว่าทำได้ไม่ค่อยดีนัก เนื่องจากเป็นการกระจายข่าวสาร แบบทั่วไป ไม่ได้แบ่งแยกประเภทหรือแสดงตามที่ผู้ใช้ให้ความสนใจ ตัวอย่างหน้า UI ของ ModLink อยู่ในรูปที่ \ref{fig:modlink}
...
\begin{enumerate}
  \item Login: ลงชื่อเพื่อเข้าใช้งานแอปพลิเคชัน
  \item Registration: สมัครบัญชีของแอปพลิเคชันด้วยอีเมลมหาวิทยาลัย
...
\end{enumerate}
\section{เเผนรูปที่ใช้เเสดงปฎิสัมพันธ์ระหว่างระบบงานเเละสิ่งที่อยู่นอกระบบงาน (Use Case Diagram)}
  ...
  จากรูปที่ \ref{fig:usecasediagram} เป็นแผนรูปที่แสดงให้เห็นความสัมพันธ์ว่าแต่ละระบบมีความเกี่ยวข้องกันอย่างไรและผู้มีส่วนเกี่ยวข้องในระบบสามารถทำอะไรได้บ้าง โดยในฝั่งของผู้ใช้งานนั้นจะเริ่มตั้งแต่สามารถสมัครบัญชีการใช้งานได้ การที่เข้าสู่ระบบเพื่อใช้งานคุณลักษณะต่าง ๆ เช่น การค้นหา, อ่านรายละเอียดและเข้าร่วมกิจกรรม การประเมินกิจกรรม การค้นหา, เข้าร่วม และลาออกจากชมรม รวมถึงงานที่ระบบ Backend กระทำต่อระบบ ทั้งการแนะนำชมรมหรือกิจกรรม แจ้งเตือนกิจกรรมที่ชมรมจัดหรือการประเมินกิจกรรมที่เกิดขึ้น\\
\textbf{Use Case Narratives} 
ส่วนนี้จะเป็นการบรรยายให้รายละเอียดเกี่ยวกับกรณีการใช้งานระบบต่าง ๆ ในตัวแอปพลิเคชันที่ถูกเขียนไว้ในเเผนรูปที่ใช้เเสดงปฎิสัมพันธ์ระหว่างระบบงานเเละสิ่งที่อยู่นอกระบบงาน ทั้งเป้าหมายของผู้ใช้งาน, เงื่อนไขการใช้งาน และขั้นตอนต่าง ๆ ในกรณีใช้งานนั้นโดยละเอียด โดยจะแบ่งเป็น 3 ส่วนหลัก ได้แก่ 
\begin{enumerate}
...
\end{enumerate}
ซึ่งแอปพลิเคชันที่เป็นผลิตภัณฑ์ของโครงการมี นั้นมีผู้กระทำหลักคือ User และผู้กระทำรองคือ Backend Logic ซึ่งขั้นตอนที่เกิดขึ้นและเงื่อนไขในการเกิดขึ้นของแต่ล่ะกรณีใช้งานมีรายละเอียดดังที่ระบุไว้ในตารางดังต่อไปนี้
...
จากรูป Sequence Diagram ในรูปที่\ref{fig:Sequence diagram ของ login} แสดงขั้นตอนการทำงานของระบบเมื่อผู้ใช้งานต้องการเข้าสู่ระบบ โดยมีรายละเอียดดังนี้
  \begin{enumerate}
...
จากรูป Sequence Diagram ในรูปที่ \ref{fig:regis} แสดงขั้นตอนการทำงานของระบบเมื่อผู้ใช้งานต้องการสมัครเข้าใช้งานระบบ โดยมีรายละเอียดดังนี้
\begin{enumerate}
...
\subsection{การออกจากระบบ}
  ...
  จากรูป Sequence Diagram ในรูปที่ \ref{fig:logout} แสดงขั้นตอนการทำงานของระบบเมื่อผู้ใช้งานต้องการออกจากระบบ โดยมีรายละเอียดดังนี้
  \begin{enumerate}
...
\subsection{การค้นหากิจกรรม}
  ...
  จากรูป Sequence Diagram ในรูปที่ \ref{fig:Search Event} แสดงขั้นตอนการทำงานของระบบเมื่อผู้ใช้งานต้องการค้นหากิจกรรม โดยมีรายละเอียดดังนี้
  \begin{enumerate}
...
\subsection{การอ่านรายละเอียดของกิจกรรมและเข้าร่วมกิจกรรม}
  ...
  จากรูป Sequence Diagram ในรูปที่ \ref{fig:Select and join event} แสดงขั้นตอนการทำงานของระบบเมื่อผู้ใช้งานต้องการอ่านรายละเอียดของกิจกรรม และเข้าร่วมกิจกรรมนั้น โดยมีรายละเอียดดังนี้
  \begin{enumerate}
...
\subsection{การประเมินกิจกรรม}
  ...
  จากรูป Sequence Diagram ในรูปที่ \ref{fig:Event evaluation} แสดงขั้นตอนการทำงานของระบบแจ้งเตือนการประเมินกิจกรรม โดยมีรายละเอียดดังนี้
  \begin{enumerate}
...
\subsection{การแจ้งเตือนกิจกรรมชมรม}
  ...
  จากรูป Sequence Diagram ในรูปที่ \ref{fig:Notification about event from club} แสดงขั้นตอนการทำงานของระบบแจ้งเตือนกิจกรรมชมรม โดยมีรายละเอียดดังนี้
  \begin{enumerate}
...
\subsection{การค้นหาชมรม}
  ...
  จากรูป Sequence Diagram ในรูปที่ \ref{fig:Seacrh club} แสดงขั้นตอนการทำงานของระบบเมื่อผู้ใช้งานต้องการค้นหาชมรม โดยมีรายละเอียดดังนี้
  \begin{enumerate}
...
\subsection{อ่านรายละเอียดของชมรมและการเข้าร่วมชมรม}
  ...
  จากรูป Sequence Diagram ในรูปที่ \ref{fig:Select and join club} แสดงขั้นตอนการทำงานของระบบเมื่อผู้ใช้งานต้องการอ่านรายละเอียดของชมรม และเข้าร่วมชมรมนั้น โดยมีรายละเอียดดังนี้
  \begin{enumerate}
...
\subsection{การลาออกจากชมรม}
  ...
  จากรูป Sequence diagram ในรูปที่ \ref{fig:Club resignation} ซึ่งแสดงการทำงานของระบบขณะที่ผู้ใช้งานทำการลาออกจากชมรม ดังนี้
  \begin{enumerate}
...
\subsection{การแนะนำกิจกรรมให้ผู้ใช้งาน}
  ...
  จากรูป Sequence diagram ในรูปที่ \ref{fig:Feed recommendation} ซึึ่งแสดงการทำงานของระบบในการแนะนำกิจกรรมให้แก่ผู้ใช้งาน ดังนี้
  \begin{enumerate}
...
\subsection{การ Train Model การเรียนรู้ของเครื่อง}
  ...
  จากรูป Sequence Diagram ในรูปที่ \ref{fig:Machine learning training} ซึ่งแสดงการทำงานของระบบในขณะที่มีการ Train Model การเรียนรู้ของเครื่องใหม่ สามารถขยายความได้ดังนี้
  \begin{enumerate}
...
เนื่องจากโครงการ Actiwiz เป็นโครงการที่จัดทำมาเพื่อที่จะอำนวยความสะดวกในเข้าร่วมกิจกรรมของนักศึกษา ดังนั้นจึงพิจารณาวิธีการแบ่งประเภทของกิจกรรมและชมรมจากเนื้อหาของกิจกรรมและชมรม โดยที่ทำการลบสัญลักษณ์พิเศษออกจากเนื้อหา แล้วโดยอาศัยหลักการของ WordEmbedding ในทำการแปลงสิ่งที่เกี่ยวข้องกับกิจกรรมและชมรมนั้น ไม่ว่าจะเป็นคำอธิบายโครงการ ชื่อโครงการ ชื่อชมรม และเนื้อหาโดยรวมของกิจกรรมที่ชมรมจัด เป็น Vector ที่แสดงถึงเนื้อหาของกิจกรรมนั้นๆ แล้วจึงทำการ Clustering เพื่อจัดเนื้อหาที่ลักษณะใกล้เคียงกันไปอยู่ใน Cluster เดียวกัน เพื่อที่จะใช้ Cluster เหล่านี้เป็น Tag ในการพิจารณาถึงสิ่งที่ควรจะแนะนำให้ผู้ใช้งาน โดยจะถูกจัดเก็บไว้เป็นโหนดในฐานข้อมูลที่จะมีความสัมพันธ์เชื่อมโยงกับทุกกิจกรรมและชมรมมที่อยู่ใน Tag เดียวกัน 
\begin{figure}[!h]\centering
  \setlength{\fboxrule}{0.5mm} % can define this in the preamble
  \setlength{\fboxsep}{0.5cm}
...
\begin{figure}[!h]\centering
  ...
  \caption{User Interface 1}\label{fig:ui1}
\end{figure}
...
\begin{figure}[!h]\centering
  ...
  \caption{User Interface 2}\label{fig:ui2}
\end{figure}
...
\begin{figure}[!h]\centering
  ...
  \caption{User Interface 3}\label{fig:ui3}
\end{figure}
...
\begin{figure}[!h]\centering
  ...
  \caption{User Interface 4}\label{fig:ui4}
\end{figure}
...
\begin{figure}[!h]\centering
  ...
  \caption{User Interface 5}\label{fig:ui5}
\end{figure}

\begin{figure}[!h]\centering
  \setlength{\fboxrule}{0.5mm} % can define this in the preamble
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=8cm]{./Pictures/Ui6.png}}
  \caption{User Interface 6}\label{fig:ui6}
\end{figure}
...
\begin{figure}[!h]\centering
  ...
  \caption{User Interface 7}\label{fig:ui7}
\end{figure}
...
\begin{figure}[!h]\centering
  ...
  \caption{User Interface 8}\label{fig:ui8}
\end{figure}

\begin{figure}[!h]\centering
  \setlength{\fboxrule}{0.5mm} % can define this in the preamble
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=8cm]{./Pictures/Ui9.png}}
  \caption{User Interface 9}\label{fig:ui9}
\end{figure}

\begin{figure}[!h]\centering
  \setlength{\fboxrule}{0.5mm} % can define this in the preamble
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=8cm]{./Pictures/Ui10.png}}
  \caption{User Interface 10}\label{fig:ui10}
\end{figure}

\begin{figure}[!h]\centering
  \setlength{\fboxrule}{0.5mm} % can define this in the preamble
  \setlength{\fboxsep}{0.5cm}
  \fbox{\includegraphics[width=8cm]{./Pictures/Ui11.png}}
  \caption{User Interface 11}\label{fig:ui11}
\end{figure}
...
\begin{figure}[!h]\centering
  ...
  \caption{User Interface 12}\label{fig:ui12}
\end{figure}
...
รายละเอียดของโครงการที่เปลี่ยนแปลงไปจากภาคการศึกษาที่ 1 ประกอบไปด้วยส่วนของการออกแบบแอปพลิเคชันต่าง ๆ ดังนี้
 ...
 \subsection{เเผนรูปที่ใช้เเสดงปฎิสัมพันธ์ระหว่างระบบงานเเละสิ่งที่อยู่นอกระบบงาน (Use Case Diagram)}
   \begin{figure}[H]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
   ...
   \end{figure}
  ทางผู้จัดทำได้มีการปรับปรุงเเผนรูปที่ใช้เเสดงปฎิสัมพันธ์ระหว่างระบบงานเเละสิ่งที่อยู่นอกระบบงาน (Use Case Diagram) จากรูปที่ \ref{fig:usecasediagram} มาเป็นรูปที่ \ref{fig:editedusecasediagram} แทน 
  ...
  \subsection{เเผนรูปที่ใช้เเสดงการทำงานของระบบ (Sequence Diagram)}
   \begin{figure}[H]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
...
\begin{table}[!h]
  ...
  \hline
  \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}Feature} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}Scenario} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}ผลที่คาดว่าจะได้รับ}\\
  \hline
  ...
  \hline
  Join Event & ผู้ใช้งานกดเข้าร่วมกิจกรรม & ระบบแสดงหน้าจอว่าผู้ใช้ได้เข้าร่วมกิจกรรมแล้ว  \\
  \hline
  ...
  \hline
  \end{tabular}
  \captionof{table}{\centering ตารางการทดสอบการทำงานของระบบ}\label{tab:functionaltesting}
...
\begin{itemize}
  ...
  \item หากได้รับการสนับสนุนด้านข้อมูลจากทางมหาวิทยาลัย จะสามารถพัฒนาความสามารถของแอปพลิเคชันของเราให้มีความสม่ำเสมอ เป็นปัจจุบัน และมีประสิทธิภาพมากยิ่งขึ้น
  \item หากได้พัฒนาต่ออยากเพิ่มฟีเจอร์เพื่ออำนวยความสะดวกให้แก่นักศึกษามากยิ่งขึ้น เช่น สามารถลงทะเบียนการเรียนได้ผ่านแอปพลิเคชันของเราได้โดยตรง
  \item หากได้พัฒนาแอปพลิเคชันต่อในอนาคต อยากทำบอทสำหรับคัดลอกฟอร์มการลงทะเบียนกิจกรรม เพื่อลดความยุ่งยากในการลงทะเบียนกิจกรรม
  \item หากได้พัฒนาแอปพลิเคชันต่ออยากทำระบบสำหรับคัดกรองกิจกรรมที่เหมาะสมกับนักศึกษา และนักศึกษาสามารถเข้าร่วมได้จริงๆ
\end{itemize}
\makeatletter
...
\hspace*{1cm} ทางคณะผู้จัดทำได้จัดทำแอปพลิเคชัน ACTIWIZ โดยมีหน้าตาของฟีทเจอร์ภายในแอปพลิเคชั่น ดังรูปที่ \ref{fig:LoginPage}-\ref{fig:Tag}
...
\appendix{หลักฐานการพัฒนาโครงการ}
% \hspace*{1cm} Functional Test \ref{fig:}-\ref{fig:}

\hspace*{1cm} ทางคณะผู้จัดทำได้จัดทำแอปพลิเคชัน ACTIWIZ โดยมีหน้าตาของฟีทเจอร์ภายในแอปพลิเคชั่น ดังรูปที่ \ref{fig:NoEmailTest}-\ref{fig:NotificationTest}

\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{./Pictures/Scene1.png}
  \caption{กรณีผู้ใช้งานไม่กรอกอีเมล}\label{fig:NoEmailTest}
\end{figure}
  \hspace*{1cm} กรณีผู้ใช้งานไม่กรอกอีเมล จะมีการแจ้งเตือนให้ผู้ใช้งานกรอกอีเมลก่อนที่จะกดเข้าสู่ระบบ

\newpage

\begin{figure}[!h]\centering
  \includegraphics[width=10cm]{./Pictures/Scene2.png}
  \caption{กรณีผู้ใช้งานไม่กรอกอีเมลไม่ถูกต้อง}\label{fig:EmailWrongTest}
\end{figure}
  \hspace*{1cm} กรณีผู้ใช้งานไม่กรอกอีเมลไม่ถูกต้อง จะมีการแจ้งเตือนให้ผู้ใช้งานกรอกอีเมลใหม่ก่อนที่จะกดเข้าสู่ระบบ
...
\end{figure}
  \hspace*{1cm} กรณีผู้ใช้ไม่กรอกรหัสผ่าน จะมีการแจ้งเตือนให้ผู้ใช้งานกรอกรหัสผ่านก่อนที่จะกดเข้าสู่ระบบ
...
\end{figure}
  \hspace*{1cm} กรณีผู้ใช้กรอกรหัสผ่านผิด จะมีการแจ้งเตือนให้ผู้ใช้งานกรอกรหัสผ่านใหม่ก่อนที่จะกดเข้าสู่ระบบ

\newpage

\begin{figure}[!h]\centering
  \includegraphics[width=8cm]{./Pictures/Scene5.jpg}
  \caption{กรณีผู้ใช้งานลองกดเข้าไปดูรายละเอียดของกิจกรรม}\label{fig:DetailEventPageTest}
\end{figure}
  \hspace*{1cm} กรณีผู้ใช้งานลองกดเข้าไปดูรายละเอียดของกิจกรรม จะมีการแสดงรายละเอียดของกิจกรรมนั้นๆ
\newpage

\begin{figure}[!h]\centering
  \includegraphics[width=8cm]{./Pictures/Scene6.png}
  \caption{กรณีผู้ใช้งานลองกดเข้าไปดูรายละเอียดของชมรม}\label{fig:DetailClubPageTest}
\end{figure}
  \hspace*{1cm} กรณีผู้ใช้งานลองกดเข้าไปดูรายละเอียดของชมรม จะมีการแสดงรายละเอียดของชมรมนั้นๆ

\newpage

\begin{figure}[!h]\centering
  \includegraphics[width=8cm]{./Pictures/Scene7.png}
  \caption{กรณีผู้ใช้งานกดเข้าร่วมกิจกรรม}\label{fig:JoinEventTest}
\end{figure}
  \hspace*{1cm} กรณีผู้ใช้งานกดเข้าร่วมกิจกรรม จะมีการแจ้งเตือนถามยืนยันการเข้าร่วมแก่ผู้ใช้งานก่อนเข้าร่วมกิจกรรม

\newpage

\begin{figure}[!h]\centering
  \includegraphics[width=8cm]{./Pictures/Scene8.png}
  \caption{กรณีผู้ใช้งานกดเข้าร่วมชมรม}\label{fig:JoinClubTest}
\end{figure}
  \hspace*{1cm} กรณีผู้ใช้งานกดเข้าร่วมชมรม จะมีการแจ้งเตือนถามยืนยันการเข้าร่วมแก่ผู้ใช้งานก่อนเข้าร่วมชมรม

\newpage

\begin{figure}[!h]\centering
  \includegraphics[width=8cm]{./Pictures/Scene9.png}
  \caption{กรณีผู้ใช้งานยกเลิกการเข้าร่วมชมรม}\label{fig:CancelJoinClubTest}
\end{figure}
  \hspace*{1cm} กรณีผู้ใช้งานยกเลิกการเข้าร่วมชมรม จะมีการแจ้งเตือนถามยืนยันการยกเลิกการเข้าร่วมแก่ผู้ใช้งานก่อนยกเลิกการเข้าร่วมชมรม
