...
ส่วนนี้จะเป็นการให้รายละเอียดเกี่ยวกับกรณีการใช้งานระบบต่าง ๆ อย่างละเอียด โดยจะแบ่งเป็น 3 ส่วนหลัก ได้แก่ 
\begin{enumerate}
  \item Goal หรือเป้าหมายของระบบ
  \item Pre-conditions หรือเงื่อนไขที่ต้องเกิดขั้นก่อนที่จะใช้งานระบบ
  \item Main Success Scenario หรือขั้นตอนการใช้งานระบบในสถานการณ์ปกติ
\end{enumerate}
โดยกรณีใช้งานที่มีอยู่ในแอปพลิเคชันของเราจะมีดังนี้ \\
การสมัครเข้าใช้งาน
\\
\begin{table}[!h]\centering
  \begin{tabular}{|c|c|}
