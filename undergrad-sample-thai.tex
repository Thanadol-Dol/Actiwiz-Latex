...
\section{เเผนภาพที่ใช้เเสดงปฎิสัมพันธ์ระหว่างระบบงานเเละสิ่งที่อยู่นอกระบบงาน (Use Case Diagram)}
  ...
  จากภาพที่ \ref{fig:usecasediagram} เป็นแผนภาพที่แสดงให้เห็นความสัมพันธ์ว่าแต่ละระบบมีความเกี่ยวข้องกันอย่างไรและผู้มีส่วนเกี่ยวข้องในระบบสามารถทำอะไรได้บ้าง โดยในฝั่งของผู้ใช้นั้นจะเริ่มตั้งแต่สามารถสมัครบัญชีการใช้งานได้ การที่เข้าสู่ระบบเพื่อใช้งานคุณลักษณะต่าง ๆ เช่น การค้นหา, อ่านรายละเอียดและเข้าร่วมกิจกรรม การประเมินกิจกรรม การค้นหา, เข้าร่วม และลาออกจากชมรม รวมถึงงานที่ระบบ Backend กระทำต่อระบบ ทั้งการแนะนำชมรมหรือกิจกรรม แจ้งเตือนกิจกรรมที่ชมรมจัดหรือการประเมินกิจกรรมที่เกิดขึ้น\\
...
รายละเอียดของโครงการที่เปลี่ยนแปลงไปจากภาคการศึกษาที่ 1 ประกอบไปด้วยส่วนของการออกแบบแอปพลิเคชันต่าง ๆ ดังนี้
  ...
  \subsection{รายการคุณลักษณะ (Feature List)}\label{subsec:editedfeaturelist}
      ด้วยวัตถุประสงค์เพื่อเพิ่มประสิทธิภาพและความสะดวกสบายแก่ผู้ใช้แอปพลิเคชัน ทางผู้จัดทำจึงได้มีการตัดสินใจให้มีการยกเลิกรูปแบบการให้ผู้ใช้ลงทะเบียนสมาชิกใหม่สำหรับแอปพลิเคชัน และดำเนินการปรับเปลี่ยนกระบวนการการเข้าสู่ระบบ (Login) และการพิสูจน์ยืนยันตัวตน (Authenticate) ของผู้ใช้
    ให้เป็นการดำเนินการผ่านระบบ Microsoft Entra ID ซึ่งเป็นระบบจัดการการพิสูจน์ยืนยันตัวตนแบบรวมศูนย์ที่ทันสมัยและได้รับการยอมรับในระดับสากล โดยผู้ใช้จะสามารถใช้บัญชี Kmutt Internet Account ซึ่งเป็นบัญชีที่ผู้ใช้ได้ลงทะเบียนไว้กับมหาวิทยาลัยเป็นที่เรียบร้อยแล้ว 
    ในการเข้าสู่ระบบและพิสูจน์ยืนยันตัวตน อย่างไรก็ตามผู้ใช้ยังจำเป็นต้องให้ข้อมูลบางอย่างและลงทะเบียนกับทางแอปพลิเคชันเพื่อให้สามารถใช้งานฟังก์ชันต่าง ๆ ของแอปพลิเคชันได้อยู่ แต่ผู้ใช้ไม่จำเป็นต้องจดจำ
  ...
  เนื่องด้วยเหตุผลสำคัญตามการเปลี่ยนแปลงที่ได้กล่าวไปในหัวข้อที่ \ref{subsec:editedfeaturelist} ด้วยเหตุนี้จึงไม่มีความจำเป็นที่จะต้องให้ผู้ใช้ลงทะเบียนบัญชีใหม่เพิ่มเติมกับแอปพลิเคชันอีกครั้ง 
...
\newpage
  ...
  จะเป็นการดําเนินการผ่านระบบ Microsoft Entra ID แทนการใช้ข้อมูลบัญชีสมาชิกที่ผู้ใช้จะต้องลงทะเบียนกับแอปพลิเคชันเพื่อเข้าใช้งานระบบของแอปพลิเคชัน และเนื่องจากไม่ต้องทำการลงทะเบียนกับแอปพลิเคชันแล้วจึงเป็นผลให้สามารถนําแผนภาพที่ \ref{fig:regis} ซึ่งเกี่ยวข้องกับการลงทะเบียนออกไปได้ เนื่องจากไม่มีความจําเป็นต่อการทํางานของระบบอีกต่อไป
  โดยแผนภาพ Sequence Diagram สำหรับกระบวนการการเข้าสู่ระบบ (Login) ที่ได้ทำการแก้ไขไปหรือรูปที่ \ref{fig:editedloginsequencediagram} นั้นแสดงลำดับการทำงานระหว่างองค์ประกอบต่าง ๆ ในระบบระหว่างกระบวนการเข้าสู่ระบบ (Login) และการพิสูจน์ยืนยันตัวตน (Authenticate) ของผู้ใช้ ซึ่งขั้นตอนการทำงานมีดังนี้:
  \begin{enumerate}
...
โดยหลังจากผู้ใช้เลือกข้อมูลทุกอย่างเสร็จเรียบร้อยตาม รูปที่ \ref{fig:FullRequestDataUser}
 ...
 โดยหลังจากผู้ใช้เลือกข้อมูลทุกอย่างเสร็จเรียบร้อยตาม รูปที่ \ref{fig:RequestDataUser} ผู้ใช้สามารถกดปุ่ม Signup Now หลังจากนั้นแอปพลิเคชันจะส่ง Request ไปยัง Backend System เพื่อเพิ่มข้อมูลผู้ใช้ใหม่ในฐานข้อมูล หลังจากนั้น Backend System จะส่ง User Id 
...
หลังจากทำการ Login เข้าระบบ ผู้ใช้สามารถกดไปที่ปุ่ม Club ที่อยู่ด้านล่างเพื่อเปลี่ยนรูปแบบของแอปพลิเคชันเป็นโหมดสำหรับชมรมตาม รูปที่ \ref{fig:3} 
...
โดยผู้ใช้สามารถกดปุ่ม Yes เพื่อออกจากระบบได้ หลังจากนั้นแอปพลิเคชันจะลบ Token ทั้งหมดและนำผู้ใช้กลับมายังหน้าแรกสุดของแอปพลิเคชันตาม รูปที่ \ref{fig:1} หรือผู้ใช้สามารถเลือกที่จะกดปุ่ม No เพื่อยกเลิกการออกจากระบบได้
  ...
  \subsection{ระบบแนะนำกิจกรรมและชมรม}
