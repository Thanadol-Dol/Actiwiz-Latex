...
\subsection{การพัฒนาของโครงการ}
  \begin{table}[!h]
    ...
    \rowcolor[HTML]{9FC5E8} 
    \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}รายการฟังก์ชันที่จะส่งมอบ}                                                                    & หลักฐาน & สถานะ      \\ \hline
    ระบบ Login ผ่านอีเมลของมหาวิทยาลัย                                                                                                         & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}} & กำลังพัฒนา \\ \hline
    \begin{tabular}[c]{@{}l@{}}ระบบรวบรวมข้อมูลของชมรมต่าง ๆ เอาไว้ โดยผู้ใช้สามารถค้นหาและ\\ ติดตามข้อมูลของชมรมที่ตนเองสนใจได้\end{tabular}   & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}} & กำลังพัฒนา \\ \hline
  \end{tabular}
    \captionof{table}{\centering ตารางการทดสอบการทดสอบการทํางาน}
  \end{table}
\newpage
\begin{table}[!h]
  ...
  \rowcolor[HTML]{9FC5E8} 
  \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}รายการฟังก์ชันที่จะส่งมอบ}                                                                    & หลักฐาน & สถานะ      \\ \hline
  ระบบแจ้งเตือนกิจกรรมที่เกี่ยวข้องกับชมรมหรือความสนใจของนักศึกษา                                                                             & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}} & กำลังพัฒนา \\ \hline
  ระบบแจ้งเตือนการประเมินผลกิจกรรม เมื่อฟอร์มการประเมินพร้อมใช้งาน                                                                            & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}} & กำลังพัฒนา \\ \hline
\end{tabular}
  \captionof{table}{\centering ตารางการทดสอบการทดสอบการทํางาน}
\end{table}
...
\begin{table}[!h]
  ...
  \rowcolor[HTML]{9FC5E8} 
  \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}รายการฟังก์ชันที่จะส่งมอบ}                                                                    & หลักฐาน & สถานะ      \\ \hline
  \begin{tabular}[c]{@{}l@{}}ระบบแนะนํากิจกรรมและชมรม ตามความสนใจของผู้ใช้โดยอ้างอิง\\ จาก tag ของกิจกรรม\end{tabular}                        & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}} & กำลังพัฒนา \\ \hline
  \begin{tabular}[c]{@{}l@{}}ระบบวิเคราะห์ความสนใจของผู้ใช้ผ่านเนื้อหาของกิจกรรมที่ผู้ใช้เคยเข้าร่วม\\  เข้าไปอ่านรายละเอียด หรือเกี่ยวข้องกับชมรมที่สนใจ\end{tabular} & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}} &
    กำลังพัฒนา \\ \hline
  \end{tabular}
  \captionof{table}{\centering ตารางการทดสอบการทดสอบการทํางาน}
\end{table}
...
\begin{table}[!h]
  ...
  \rowcolor[HTML]{9FC5E8} 
  \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}รายการฟังก์ชันที่จะส่งมอบ}                                                                    & หลักฐาน & สถานะ      \\ \hline
  \begin{tabular}[c]{@{}l@{}}ระบบแยกประเภทกิจกรรมอัตโนมัติโดยวิเคราะห์จากเนื้อหา \\ ออกมาเป็น tag ต่าง ๆ โดยใช้ Machine Learning\end{tabular} & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}} & กำลังพัฒนา \\ \hline
\end{tabular}
  \captionof{table}{\centering ตารางการทดสอบการทดสอบการทํางาน}
\end{table}
...
\begin{table}[!h]
  \centering
  \captionsetup{justification=centering}
  \begin{tabular}{|l|p{3cm}|p{5cm}|m{4cm}|} 
  \hline
  \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}Feature} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}Scenario} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}ผลที่คาดว่าจะได้รับ} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}ผลที่ได้รับ} \\
  \hline
  \multirow{4}{*}{Login}& ผู้ใช้งานไม่กรอกอีเมล หมายเลขโทรศัพท์ หรือชื่อ Skype ที่ถูกต้อง & ระบบ Microsoft Login แจ้งเตือน "ใส่ที่อยู่อีเมล หมายเลขโทรศัพท์ หรือชื่อ Skype ที่ถูกต้อง" & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}}\\
  \cline{2-4}
  & ผู้ใช้งานไม่กรอกรหัสผ่าน & ระบบ Microsoft Login แจ้งเตือน "โปรดป้อนรหัสผ่านของคุณ" & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}}\\
  \hline
  \end{tabular}
  \captionof{table}{\centering ตารางการทดสอบการทดสอบการทำงาน}\label{tab:functionaltesting}
  จากตารางที่ \ref{tab:functionaltesting} เป็นรายการสำหรับทดสอบการทำงานของฟังก์ชันต่าง ๆ ในแอพลิเคชัน เพื่อทดสอบว่าการตอบสนองต่อการใช้งานต่าง ๆ เป็นไปตามที่ออกแบบไว้หรือไม่
...
\begin{table}[!h]
  ...
  \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}Feature} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}Scenario} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}ผลที่คาดว่าจะได้รับ} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}ผลที่ได้รับ} \\
  \hline
  \multirow{4}{*}{Login}& ผู้ใช้งานกรอกอีเมลผิด & ระบบ Microsoft Login แจ้งเตือน "เราไม่พบบัญชีที่มีชื่อผู้ใช้ดังกล่าว" & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}}\\
  \cline{2-4}
  & ผู้ใช้งานกรอกรหัสผ่านผิด & ระบบ Microsoft Login แจ้งเตือน "บัญชีหรือรหัสผ่านของคุณไม่ถูกต้อง" & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}}\\
  \hline
  \end{tabular}
  \captionof{table}{\centering ตารางการทดสอบการทดสอบการทำงาน}\label{tab:functionaltesting}
  จากตารางที่ \ref{tab:functionaltesting} เป็นรายการสำหรับทดสอบการทำงานของฟังก์ชันต่าง ๆ ในแอพลิเคชัน เพื่อทดสอบว่าการตอบสนองต่อการใช้งานต่าง ๆ เป็นไปตามที่ออกแบบไว้หรือไม่
...
\begin{table}[!h]
  ...
  \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}Feature} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}Scenario} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}ผลที่คาดว่าจะได้รับ} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}ผลที่ได้รับ} \\
  \hline
  \multirow{2}{*}{Feed page} & ผู้ใช้งานกดดูรายละเอียดกิจกรรม & ระบบแสดงหน้ารายละเอียดของกิจกรรม & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}}\\
  \cline{2-4}
  & ผู้ใช้งานกดดูรายละเอียดของชมรม & ระบบแสดงหน้ารายละเอียดของชมรม & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}}\\
  \hline
  \end{tabular}
  \captionof{table}{\centering ตารางการทดสอบการทดสอบการทำงาน}\label{tab:functionaltesting}
  จากตารางที่ \ref{tab:functionaltesting} เป็นรายการสำหรับทดสอบการทำงานของฟังก์ชันต่าง ๆ ในแอพลิเคชัน เพื่อทดสอบว่าการตอบสนองต่อการใช้งานต่าง ๆ เป็นไปตามที่ออกแบบไว้หรือไม่
...
\begin{table}[!h]
  ...
  \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}Feature} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}Scenario} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}ผลที่คาดว่าจะได้รับ} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}ผลที่ได้รับ} \\
  \hline
  \multirow{2}{*}{Join Event} & ผู้ใช้งานกดเข้าร่วมกิจกรรม & ระบบแสดงหน้าจอว่าผู้ใช้ได้เข้าร่วมกิจกรรมแล้ว & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}}\\
  \cline{2-4}
  & ผู้ใช้งานกดยกเลิกการเข้าร่วมกิจกรรม & \begin{tabular}[c]{@{}l@{}}ระบบแสดงหน้าจอว่าผู้ใช้ได้ยกเลิก\\การเข้าร่วมกิจกรรมแล้ว\end{tabular} & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}}\\
  \hline
  \end{tabular}
  \captionof{table}{\centering ตารางการทดสอบการทดสอบการทำงาน}\label{tab:functionaltesting}
  จากตารางที่ \ref{tab:functionaltesting} เป็นรายการสำหรับทดสอบการทำงานของฟังก์ชันต่าง ๆ ในแอพลิเคชัน เพื่อทดสอบว่าการตอบสนองต่อการใช้งานต่าง ๆ เป็นไปตามที่ออกแบบไว้หรือไม่
...
\begin{table}[!h]
  ...
  \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}Feature} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}Scenario} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}ผลที่คาดว่าจะได้รับ} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}ผลที่ได้รับ} \\
  \hline
  \multirow{2}{*}{Join Club} & ผู้ใช้งานกดเข้าร่วมชมรม & ระบบแสดงหน้าจอว่าผู้ใช้ได้เข้าร่วมชมรมแล้ว & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}}\\
  \cline{2-4}
  & ผู้ใช้งานกดยกเลิกการเข้าร่วมชมรม & ระบบแสดงหน้าจอว่าผู้ใช้ได้ยกเลิกการเข้าร่วมชมรมแล้ว & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}}\\
  \hline
  \end{tabular}
  \captionof{table}{\centering ตารางการทดสอบการทดสอบการทำงาน}\label{tab:functionaltesting}
  จากตารางที่ \ref{tab:functionaltesting} เป็นรายการสำหรับทดสอบการทำงานของฟังก์ชันต่าง ๆ ในแอพลิเคชัน เพื่อทดสอบว่าการตอบสนองต่อการใช้งานต่าง ๆ เป็นไปตามที่ออกแบบไว้หรือไม่
...
\begin{table}[!h]
  ...
  \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}Feature} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}Scenario} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}ผลที่คาดว่าจะได้รับ} & \multicolumn{1}{c|}{\cellcolor[HTML]{9FC5E8}ผลที่ได้รับ} \\
  \hline
  Notification & ผู้ใช้กดเข้าไปดูแจ้งเตือนจากทางระบบ & \begin{tabular}[c]{@{}l@{}}ระบบแสดงหน้าจอเกี่ยวกับการแจ้งเตือนนั้น ๆ \\ เช่น ระบบแสดงหน้าจอการประเมินกิจกรรม\end{tabular} & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}}\\
  \hline
  Evaluate Page & ผู้ใช้กดเพื่อเข้าไปประเมินกิจกรรม & ระบบพาผู้ใช้เข้าสู่หน้า login เพื่อประเมินกิจกรรม & \fbox{\includegraphics[width=4cm]{./Pictures/Mobile_Arc2.png}}\\
  \hline
  \end{tabular}
  \captionof{table}{\centering ตารางการทดสอบการทดสอบการทำงาน}\label{tab:functionaltesting}
  จากตารางที่ \ref{tab:functionaltesting} เป็นรายการสำหรับทดสอบการทำงานของฟังก์ชันต่าง ๆ ในแอพลิเคชัน เพื่อทดสอบว่าการตอบสนองต่อการใช้งานต่าง ๆ เป็นไปตามที่ออกแบบไว้หรือไม่
