...
\FloatBarrier
  \subsection {REST API} 
    ...
    \subsubsection {การออกแบบ REST API \cite{RestAPIDesign}}
      ...
      \begin{enumerate}
        \item สำหรับการออกแบบ RESTful API ควรเลือกใช้ HTTP Method ให้สอดคล้องกับลักษณะการดำเนินการของแต่ละ API ตามหลักการปฏิบัติที่ดี โดยทั่วไปไม่ควรใส่ชื่อกริยาที่บ่งบอกถึงการดำเนินการของ API ไว้ในส่วนของ Path เช่น /createUsers หรือ /getUserDetail เนื่องจากหน้าที่ของ API ปกติจะถูกกำหนดโดย HTTP Method ด้วยเหตุนี้ ชื่อ Path ควรเป็นชื่อของทรัพยากร (Resource) ที่เกี่ยวข้องกับ API ดังกล่าว เช่น /users หรือ /users/{userId} เป็นต้น
        \item การออกแบบ RESTful API ให้ตรงตามแนวปฏิบัติที่ดีมีหลักเกณฑ์สำคัญที่ควรยึดถือ ดังนี้

        \begin{itemize}
          \item URL Path ควรประกอบด้วยชื่อของทรัพยากร (Resource) เท่านั้น เช่น Users, Customers หรือ Orders เป็นต้น ซึ่งทรัพยากรเหล่านี้เป็นตัวแทนของข้อมูลหรือสิ่งของบางอย่าง
          \item ชื่อ Path ควรอยู่ในรูปพหูพจน์ของทรัพยากร 
          \item ไม่ควรใส่ชื่อกริยาที่บ่งบอกถึงวัตถุประสงค์ของการดำเนินการ เช่น add, update หรือ delete เป็นต้น เนื่องจากหน้าที่การดำเนินการปกติจะถูกกำหนดโดย HTTP Method
        \end{itemize}
      
        ตามหลักเกณฑ์ดังกล่าว หากต้องการ API ที่เกี่ยวข้องกับทรัพยากร Users ซึ่งมีความสามารถในการสร้าง แก้ไข แสดง และลบข้อมูล User สามารถออกแบบ API Endpoint ได้ดังนี้
