...
\begin{itemize}
  ...
  \begin{figure}[!h]\centering
    ...
    \caption{แผนภาพคะแนนความพึงพอใจในการแก้ปัญหาของ Application}\label{fig:Problemssolvingsatisfaction}
  \end{figure}
\end{itemize}
    ...
    \begin{tabular}{|c|c|c|c|}
      ...
      \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}ระดับความพึงพอใจ} &
       ...
       5 & 20
         \\ \hline
    \end{tabular}
    \captionof{table}{\centering ตารางความสะดวกในการใช้งาน Application}\label{tab:Comfortability}
  \end{table}
  \begin{figure}[!h]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
    \fbox{\includegraphics[width=8cm]{./Pictures/easytouse.png}}
    \caption{แผนภาพคะแนนความสะดวกในการใช้งาน Application}\label{fig:Comfortability}
  \end{figure}
\end{itemize}
จากผลลัพธ์การประเมินในส่วนของความสะดวกในการใช้งาน Application ตามตารางที่ \ref{tab:Comfortability} และรูปที่ \ref{fig:Comfortability} พบว่าค่าเฉลี่ยของความพึงพอใจจากคะแนนจาก 5 คะแนนมีคะแนนเฉลี่ยอยู่ที่ 4.58 ซึ่งนับว่าค่าเฉลี่ยของผลการประเมินอยู่ในเกณฑ์ดีเยี่ยม
\newpage
\begin{itemize}
    ...
    \begin{tabular}{|c|c|c|c|}
      ...
      \multicolumn{1}{|c|}{\cellcolor[HTML]{9FC5E8}ระดับความพึงพอใจ} &
       ...
       5 & 19
         \\ \hline
    \end{tabular}
    \captionof{table}{\centering ตารางความพึงพอใจโดยรวมของ Application}\label{tab:Featuresatisfaction}
  \end{table}
  \begin{figure}[!h]\centering
    \setlength{\fboxrule}{0.5mm} % can define this in the preamble
    \setlength{\fboxsep}{0.5cm}
    \fbox{\includegraphics[width=8cm]{./Pictures/satisfaction.png}}
    \caption{แผนภาพคะแนนความพึงพอใจโดยรวมของ Application}\label{fig:Featuresatisfaction}
  \end{figure}
\end{itemize}
จากผลลัพธ์การประเมินในความพึงพอใจโดยรวมของ Application ตามตารางที่ \ref{tab:Featuresatisfaction} และรูปที่ \ref{fig:Featuresatisfaction} พบว่าค่าเฉลี่ยของความพึงพอใจจากคะแนนจาก 5 คะแนนมีคะแนนเฉลี่ยอยู่ที่ 4.44 ซึ่งนับว่าค่าเฉลี่ยของผลการประเมินอยู่ในเกณฑ์ดีมาก
...
\end{figure}
  \hspace*{1cm} ฐานข้อมูลของชมรมในมหาวิทยาลัย นั้นเป็นฐานข้อมูลที่เก็บข้อมูลของชมรมที่มีอยู่ในมหาวิทยาลัย โดยมีข้อมูลของชมรมทั้งหมด 2565 รายการ
